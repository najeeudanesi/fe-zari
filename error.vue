<template>
  <div class="contents">
    <div class="flex h-screen w-screen flex-col items-center justify-center space-y-8 text-primary">
      <Title>There's an error on our end</Title>
      <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" class="w-72" viewBox="0 0 1119.60911 699"
        ...
        <path d="M140.09162,291.85056c0-78.36865,54.255-141.78356,121.30372-141.78356"
          transform="translate(-31.39089 -100.5)" fill="currentColor" />
      ...
      <h1 class="text-xl text-gray-600 sm:text-3xl">
        There's an error on our end
      </h1>
      <a href="/" class="Btn">&larr; <span class="ml-2">Refresh Page</span></a>
    </div>
  </div>
</template>
